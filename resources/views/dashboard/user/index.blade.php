...
<div class="table-responsive small">
    <a href="/dashboard/user/create" class="btn btn-success btn-sm mb-3" style="background-color: #FFCBCB; border-color: #FFCBCB;">Tambah Data</a>
    <table class="table table-striped table-sm">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="/dashboard/user/{{ $user->user_id }}/edit" class="btn btn-warning btn-sm" style="background-color: #FFCBCB; border-color: #FFCBCB;"><i class="bi bi-pencil"></i></a>
