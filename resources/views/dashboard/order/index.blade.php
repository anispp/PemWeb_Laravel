...
<div class="table-responsive small">
    <a href="/dashboard/order/create" class="btn btn-success btn-sm mb-3" style="background-color: #FFCBCB; border-color: #FFCBCB;">Tambah Data</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="/dashboard/order/{{ $order->order_id }}/edit" class="btn btn-warning btn-sm" style="background-color: #FFCBCB; border-color: #FFCBCB;"><i class="bi bi-pencil"></i></a>
